...
public abstract class BasePage {
    ...
    protected void clickElement(By locator) {
        WebElement element = pageDriver.driver.findElement(locator);
        waitForElementClickable(element);
        element.click();
    }
    ...
    protected void verifyIfAElementIsDisplayed(By locator) {
        waitForElementVisible(pageDriver.driver.findElement(locator));
    }

    protected void verifyIfAElementIsDisplayed(WebElement element) {
        waitForElementVisible(element);
    }

    protected void verifyIfAElementNotDisplayed(By locator) {
        waitForElementNotVisible(pageDriver.driver.findElement(locator));
    }
}
